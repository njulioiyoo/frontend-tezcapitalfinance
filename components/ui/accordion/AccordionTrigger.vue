...
<template>
  <AccordionHeader class="flex">
    ...
    >
      ...
      <slot name="icon">
        <ChevronDown
          class="text-red-100 pointer-events-none size-5 shrink-0 translate-y-0.5 transition-transform duration-200"
        />
      </slot>
    </AccordionTrigger>
  </AccordionHeader>
