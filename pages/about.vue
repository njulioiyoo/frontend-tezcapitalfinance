...
watchEffect(() => {
  useSeoMeta({
    ...
    description: computed(() => bannerDescription.value || appDescription.value || 'Learn about our mission, vision, values, and the team behind our trusted financing solutions.'),
  })
})
</script>
