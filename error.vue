        ...
        <div class="max-w-2xl w-full text-center">
          ...
          <div class="mb-6 sm:mb-8">
            <img 
              ...
              class="h-12 sm:h-14 md:h-16 mx-auto"
            />
          </div>

          <!-- Error Icon -->
          <div class="mb-6 sm:mb-8">
            <div class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto bg-red-100 rounded-full flex items-center justify-center">
          ...
          <!-- Error Details -->
          <h1 class="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold text-black-100 mb-3 sm:mb-4">
            {{ error.statusCode }} - {{ error.statusMessage }}
          </h1>

          <p class="text-base sm:text-lg md:text-xl xl:text-2xl text-black-100 mb-6 sm:mb-8 leading-relaxed">
            {{ $t('error.serverError') }}
          </p>
          ...
          <button 
            ...
            class="bg-red-100 hover:bg-red-200 text-white font-medium py-3 px-6 sm:py-4 sm:px-8 rounded-lg transition-colors duration-200 text-sm sm:text-base"
          >
            {{ $t('error.backToHome') }}
          </button>
